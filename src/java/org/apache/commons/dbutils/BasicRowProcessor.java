...
public class BasicRowProcessor implements RowProcessor {
    ...
    private static class CaseInsensitiveHashMap extends HashMap {
        ...
        public boolean containsKey(Object key) {
            Object realKey = key.toString().toLowerCase();
	 ...
	 * org.apache.commons.dbutils.PageArgument)
     */
    public List toBeanList(ResultSet rs, Class type, PageArgument pageArg) throws SQLException {
        return this.convert.toBeanList(rs, type, pageArg);
    }
